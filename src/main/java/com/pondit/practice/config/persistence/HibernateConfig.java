package com.pondit.practice.config.persistence;
...
@EnableJpaRepositories("com.pondit.practice.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.pondit.practice.model");
                for (Class<?> clazz : (new Reflections("com.pondit.practice.model")).getTypesAnnotatedWith(Entity.class)) {
